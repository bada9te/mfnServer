...
export declare class AddNewBattleByPostsIdsInput {
    initiator: string;
    title: string;
    post1: string;
    post2: string;
...
export declare class MakeBattleVoteInput {
    battleId: string;
    postNScore: string;
    voteCount: number;
    voterId: string;
}
export declare class CreateModerationActionInput {
    user: string;
    type: string;
}
export declare class ModerateActionInput {
    userId: string;
    actionId: string;
    type: string;
    verifyToken: string;
...
export declare class SwitchTrackInPlaylistInput {
    playlistId: string;
    trackId: string;
}
export declare class SwitchTrackInPlaylistsInput {
    playlistsIds?: Nullable<string[]>;
    trackId: string;
}
export declare class PostsByTitleInput {
    title: string;
    userId?: Nullable<string>;
    userIsOwner?: Nullable<boolean>;
}
export declare class AddPostInput {
    owner: string;
    title: string;
    description: string;
    audio: string;
...
export declare class CreateSupportRequestInput {
    contactReason: string;
    email: string;
    message: string;
}
export declare class LinkEmailInput {
    userId: string;
    email: string;
}
export declare class SwitchLikeOrPostInSavedInput {
    userId: string;
    postId: string;
}
...
export declare class SwitchSubscriptionOnUserInput {
    subscriberId: string;
    userId: string;
}
export declare class AccountConfirmInput {
    userId: string;
    actionId: string;
    verifyToken: string;
}
export declare class AccountRestoreInput {
    userId: string;
    actionId: string;
    verifyToken: string;
    type: string;
...
export declare class PrepareAccountToRestoreInput {
    email: string;
    type: string;
}
...
export declare class BattlesWithCount {
...
export declare class NotificationsWithCount {
    notifications?: Nullable<Notification[]>;
    count: number;
}
export declare class NotificationCount {
    count: number;
}
...
export declare class PlaylistsWithCount {
    playlists?: Nullable<Playlist[]>;
    count: number;
}
export declare class PostsWithCount {
    posts?: Nullable<Post[]>;
    count: number;
}
export declare class PostsByCategoryCount {
    country: number;
    pop: number;
    classical: number;
    funk: number;
...
export declare class SocialMediaData {
    email?: Nullable<string>;
    name?: Nullable<string>;
}
export declare class TwoUsers {
    subscriber: User;
    subscribeOn: User;
}
export declare class UserWithAction {
    user: User;
    action: ModerationAction;
}
export declare class SwitchLikeOrPostInSavedReturnType {
    post: Post;
    user: User;
}
export declare class UserAchievementsData {
    achievements?: Nullable<number[]>;
    totalLikes: number;
    totalSaves: number;
